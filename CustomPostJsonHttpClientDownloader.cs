...
namespace spiderproject
{
    ...
    /// 纯HTTP下载器
    /// </summary>
    public class CustomPostJsonHttpClientDownloader : BaseDownloader
    {
        /// <summary>
        ...
        /// 构造方法
        /// </summary>
        public CustomPostJsonHttpClientDownloader()
        {
        ...
        public CustomPostJsonHttpClientDownloader(int timeout = 5, bool decodeHtml = false) : this()
        {
            _timeout = timeout;
        ...
        private HttpRequestMessage GenerateHttpRequestMessage(Request request, Site site)
        {
            ...
            if (httpRequestMessage.Method == HttpMethod.Post)
            {
                ...
                httpRequestMessage.Content = new StringContent(request.PostBody, Encoding.UTF8, "application/json");
